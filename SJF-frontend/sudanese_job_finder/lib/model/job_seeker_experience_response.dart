...
List<JobSeekerExperienceResponse> jobSeekerExperienceResponseFromJson(
        String str) =>
    List<JobSeekerExperienceResponse>.from(
        json.decode(str).map((x) => JobSeekerExperienceResponse.fromJson(x)));

String jobSeekerExperienceResponseToJson(
        List<JobSeekerExperienceResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class JobSeekerExperienceResponse {
  int? id;
  ...
  JobSeekerExperienceResponse copyWith({
    int? id,
    int? jobSeekerProfile,
    String? experienceRole,
    DateTime? startDate,
  ...
  factory JobSeekerExperienceResponse.fromJson(Map<String, dynamic> json) =>
      JobSeekerExperienceResponse(
        id: json["id"],
