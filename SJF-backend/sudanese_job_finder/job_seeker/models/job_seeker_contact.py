...
class JobSeekerContact(models.Model):
    job_seeker_profile = models.ForeignKey(to=JobSeekerProfile, on_delete=models.CASCADE, related_name='contacts')
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='job_seeker_contact_created_by',
    ...
    modified_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='job_seeker_contact_modified_by',
        on_delete=models.SET_NULL
    )
